Locales['en'] = {
    ...
    ['press_to_inventory'] = 'press ~INPUT_CONTEXT~ to access the ~y~Storage~s~',
    ['press_to_cloakroom'] = 'press ~INPUT_CONTEXT~ to access the ~y~Cloakroom~s~',
}
